  ...
  return (
    <div >
      <Flex justifyContent={"space-around"} alignItems={"center"} padding="10px" position={"fixed"} top="0" width="100%" zIndex={"999"} backgroundColor="#fff" >
        <Box>
       <Link to="/"><Image src="https://assets.ajio.com/static/img/Ajio-Logo.svg" width="150px"></Image></Link> 
        </Box>
        <Box>
        <Flex gap="30px" alignItems={"center"}>
            <Link to="/men" onClick={()=>setCategory("mens-clothing")}>
            <Box >
                <Menuitem navitem={"MEN"} item1={
                    <Box>
                    <Flex gap="20px">
                        <Text>Shop By:</Text>
                    ...
                    <Flex gap="50px">
                        <Box lineHeight={"40px"}>
                            <Text  fontWeight="500" cursor={"pointer"}>CLOTHING</Text>
                            <Text  fontWeight="500" cursor={"pointer"}>FOOTWEAR</Text>
                            <Text  fontWeight="500" cursor={"pointer"}>ACCESSORIES</Text>
                            <Text  fontWeight="500" cursor={"pointer"}>ALL THATS NEW</Text>
                            <Text  fontWeight="500" cursor={"pointer"}>AJIO GLOBAL</Text>
                            <Text  fontWeight="500" cursor={"pointer"}>WINTERWEAR</Text>
                            <Text  fontWeight="500" cursor={"pointer"}>NIGHT & LAUNGEWEAR</Text>
                            <Text  fontWeight="500" cursor={"pointer"}>GROOMING</Text>
                            <Text  fontWeight="500" cursor={"pointer"}>ETHNIC & FESTIVE</Text>
                            </Box>
                            <Box>
                            <Text  fontWeight="500" cursor={"pointer"}>WESTERN WEAR</Text>
                            ...
                            <Text  fontWeight="500" cursor={"pointer"}>PRECIOUS JEWELLERY</Text>
           ...
           <Box>
            ...
            <Box><Menuitem navitem={"HOME & KITCHEN"} item1={
                    <Box>
                    <Flex gap="20px">
                        <Text>Shop By:</Text>
                        <Text>Categories</Text>
